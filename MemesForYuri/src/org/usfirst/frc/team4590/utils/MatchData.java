...
import org.usfirst.frc.team4590.robot.commands.auto.AutoPassLine;
import org.usfirst.frc.team4590.robot.commands.auto.AutoProteccGear;
import org.usfirst.frc.team4590.robot.commands.auto.AutoSuccAtsmon;
...
public class MatchData {
	...
	//	m_autoChooser.addDefault("Basic Gears Auto", new BasicGearsAutoJoel());
		...
		//offseason
		m_autoChooser.addDefault("Offseason - Pass Auto Line", new AutoPassLine());
		m_autoChooser.addObject("Offseason - Pass Auto Line And Shoot" , new AutoSuccAtsmon());
		m_autoChooser.addObject("Offseason - Pass Auto Line And Place" , new AutoProteccGear());
		
		m_autoChooser.addObject("Drive with oded", new DriveForwardForOded());
