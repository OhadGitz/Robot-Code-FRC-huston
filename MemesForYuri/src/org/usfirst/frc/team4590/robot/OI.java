...
import org.usfirst.frc.team4590.robot.commands.auto.DriveForwardForOded;
import org.usfirst.frc.team4590.robot.commands.auto.RunAutoCommand;
import org.usfirst.frc.team4590.robot.commands.auto.TeleopShootFromHopper;
...
import org.usfirst.frc.team4590.robot.commands.chassis.InvertMotors;
...
import org.usfirst.frc.team4590.robot.commands.shooter.ShooterTeleopCommand;
...
public class OI {
	...
	private static final double JOYSTICK_DEADZONE = 0.22;//1.65 //0.145;
	...
	private OI() {
		...
		mainJS.getButton(JoystickBinding.X).whenPressed(new InvertMotors());
...
//		subJS.getButton(JoystickBinding.L1).whenPressed(new TurnByCircularSpeed(true));  //WOHA BABY WATCH OUT
		
				
		subJS.getButton(JoystickBinding.START).whileHeld(new FeedToShooterTeleop());
		subJS.getButton(JoystickBinding.R1).whileHeld(new ShooterTeleopCommand());
		...
		mainJS.getButton(JoystickBinding.X).whenReleased(new Command() {
